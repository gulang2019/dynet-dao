...
```
# cd <repo dir>
build/examples/transformer-lm -c models/gpt2-124M/hparams.ini --model-path models/gpt2-124M-dbg --reset-if-stuck --use-smaller-minibatch --dao-profile 1 --train-percent 100 2>&1 | tee models/gpt2-124M/train.log
```
