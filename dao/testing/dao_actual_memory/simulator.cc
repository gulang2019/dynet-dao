...
void print_kernel(Kernel kernel) {
    cout << "printing information about kernel accesses" << endl;
    for (size_t i = 0; i < kernel.accesses.size(); i++) {
        cout << "Access Tensor UID: " << kernel.accesses[i] << endl;
    }
    cout << "printing information about kernel free lists" << endl;
    for (size_t i = 0; i < kernel._free_list.size(); i++) {
        cout << "Free list UID: " << kernel._free_list[i] << endl;
    } 
}
